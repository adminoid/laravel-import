...
class ProductClear extends ProductImportTemplate
{

    public function __construct($file, $cmd)
    {
        // todoParse1 Заменить №1, больше менять нигде не надо!
        $this->name = 'oral-cavity-irrigators';
    ...
    public function run()
    {
        ...
        $this->items = $products->manufacter->{$this->name}->item;
