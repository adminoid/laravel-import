...
class ImportSphygmomanometers {
    ...
    public function prepare(){
        ...
        $xmlPath = 'import/xmls/sphygmomanometers.xml';
        $this->nodeName = 'sphygmomanometers';
    ...
    public function transformPaths($fromUrl)
    {
        ...
        // public/files/pdf/poverka/sphygmomanometers/http:/www.csmedica.ru/upload/poverka/20140200001lg_20140208940lg.pdf
        if(strpos($toFile, '20140200001lg_20140208940lg')){

            $this->cmd->line('<yellow-blue>Дамп той папки http </yellow-blue>');

            // string(151) "/Users/petja/PhpstormProjects/ikmed.ru/public/files/pdf/poverka/sphygmomanometers/http://www.csmedica.ru/upload/poverka/20140200001lg_20140208940lg.pdf"
            $toFile = "/Users/petja/PhpstormProjects/ikmed.ru/public/files/pdf/poverka/20140200001lg_20140208940lg.pdf";

            // string(106) "/files/pdf/poverka/sphygmomanometers/http://www.csmedica.ru/upload/poverka/20140200001lg_20140208940lg.pdf"
            $relativePath = "/files/pdf/poverka/sphygmomanometers/20140200001lg_20140208940lg.pdf";
